...
const sortPeopleBetter = (arr) => {
  arr.sort ((a , b) => {
    if (a.lastName === b.lastName && a.firstName.toLowerCase() === b.firstName.toLowerCase()){
      return a.age > b.age;
...
let daysOfTheWeekArray = ['Monday', 'Tuesday','Wednesday', 'Thursday', 'Friday'];
...
const sortMeetingsByDay = (arr) => {
  arr.sort((a, b) => {
    return daysOfTheWeekArray.indexOf(a.dayOfWeek) > daysOfTheWeekArray.indexOf(b.dayOfWeek);
  })
  return arr;
};
